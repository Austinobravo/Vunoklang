...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('author', models.FileField(blank=True, help_text="Authors's Guide", null=True, upload_to='authors')),
            ],
        ),
        migrations.CreateModel(
            name='BookDetailPost',
            fields=[
                ...
                ('slug', models.SlugField(blank=True, help_text="Don't Edit, It Populates itself", max_length=200, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('editor', models.CharField(choices=[('chief_editor', 'chief_editor'), ('editorial_board', 'editorial_board'), ('consulting_editor', 'consulting_editor')], default='editorial_board', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Owner_Details',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(blank=True, help_text='Numberof comments in a post', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='vunoklang_app.bookdetailpost')),
            ],
        ),
        migrations.AddField(
            model_name='bookdetailpost',
            name='category',
            field=models.ForeignKey(blank=True, help_text='Choose the ctegory your book fall in.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='category', to='vunoklang_app.category'),
        ),
    ]
