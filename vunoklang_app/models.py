...
class Authors_Guide(models.Model):
    author = models.FileField(upload_to="authors", help_text="Authors's Guide", null=True, blank=True)

    class Meta:
        verbose_name="Author's Guide"
        verbose_name_plural="Author's Guide" 
...
class Category(models.Model): #Category for the Article
    volume = models.CharField(max_length=200) #Title of the Category
...
Editors = (
    ...
    ("consulting_editor", "consulting_editor"),
...
class EditorialMembers(models.Model):
    ...
    editor=models.CharField(choices=Editors, max_length=200, default="editorial_board")
